...
class AquariumTest {
    ...
    void testAddCompatibleInhabitant() {
        Inhabitant fish = inhabitantFactory.createInhabitant("fish", "Clownfish", "Nemo", OWNER_ID, Optional.of("Orange"), Optional.of(1), Optional.of(false), Optional.of(WaterType.FRESHWATER), Optional.of("A friendly fish"), new InhabitantProperties(false, false, false));
    ...
    void testAddIncompatibleInhabitant() {
        Inhabitant snailEater = inhabitantFactory.createInhabitant("fish", "Puffer", "KillerFish", OWNER_ID, Optional.of("Yellow"), Optional.of(1), Optional.of(false), Optional.of(WaterType.FRESHWATER), Optional.of("Eats snails"), new InhabitantProperties(false, false, true));
        Inhabitant snail = inhabitantFactory.createInhabitant("snail", "Garden Snail", "Gary", OWNER_ID, Optional.of("Brown"), Optional.of(1), Optional.of(false), Optional.of(WaterType.FRESHWATER), Optional.of("A slow snail"), new InhabitantProperties(false, false, false));
